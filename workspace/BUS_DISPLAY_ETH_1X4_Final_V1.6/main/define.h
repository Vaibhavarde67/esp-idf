...
#define SCR_TIMER_DIVIDER	160-1
...
#define SCROLLING_TIME	 	9000-1		//Actually we get stable output at 100MSec interval
...
//Enter Display refresh time in microsecond now in our case it is 4Msec
#define DIS_REFRESH_TIME	1800-1		//Actually we get stable output at 5MSec interval
...
#define P6_HOST    HSPI_HOST
//SPi data transfer speed
#define CONFIG_P6_SPI_CLOCK_MHZ	21	//As per 74HC595 Datasheet max 21MHz

#define NOT_USED		-1


//For Inyencity Control
#define MIN_INTENCITY		10
#define MAX_INTENCITY		50
#define INTENCITY_HS_TIMER          LEDC_TIMER_1
#define INTENSITY_HS_MODE           LEDC_LOW_SPEED_MODE
