...
#define DWIN_FRAME_LEN 35
#define DWIN_MIN_FRAME_LEN 6
#define DWIN_MAX_STR_LEN 20
...
#define LCD_TXT_MAX_LEN								30//this is max lenth of all texts
...
//esp_err_t DWIN_WriteString(uint16_t addr, char* str);
//
